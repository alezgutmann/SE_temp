...
/**
 * Die Klasse {@code Artikel} repräsentiert einen Artikel mit Preis, Artikelnummer, Name und Vorschaubild.
 * Sie kann einen Artikel aus einer JSON-Datei laden.
 */
public class Artikel{
	...
	public Artikel() {
	 ...
	 /**
     * Konstruktor zum Erstellen eines Artikels mit allen Eigenschaften.
     * Wird allerdings so nicht zum initialisieren verwendet, 
     * da er in artikelladen() enthalten ist.
     *
	...
	public String toString() {
		return "Artikel{ " + "preis=" + preis + ", artikelNR=" + artikelNR + ", name=" + name + ", vorschaubild=" + vorschaubild + " }";
	}
